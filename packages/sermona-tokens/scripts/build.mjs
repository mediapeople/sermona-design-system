...
/* Multi-line display inside VitePress / prose: block lines beat fragile <br/> line boxes. */
.sermona-display-hero__line,
.sermona-display-light__line {
  display: block;
}

.sermona-display-hero__line + .sermona-display-hero__line,
.sermona-display-light__line + .sermona-display-light__line {
  margin-top: 0.14em;
}

.sermona-display-hero br,
.sermona-display-light br {
  display: block;
  margin-top: 0.42em;
}
...
.sermona-meta {
  font-family: var(--sermona-font-family-sans);
  font-weight: var(--sermona-font-weight-regular);
  font-size: var(--sermona-font-size-caption);
  line-height: var(--sermona-line-height-caption);
  letter-spacing: var(--sermona-letter-spacing-meta);
  color: var(--sermona-color-text-subtle);
  margin: 0;
}
